...
public class StatusCommand implements Command {
	...
	public String execute(HttpServletRequest req, HttpServletResponse resp) throws AppException {
		String address = "controller?command=menu&button=allOrders";
		...
		try {
			DAOFactory.getInstatance().getOrderDAO().changeOrderStatus(con, id, status);
		} catch (DBException e) {
